        ...
        <section id='contact'>
            ...
            <div className="container contact__container">
                ...
                <form className='contact__form' ref={form} onSubmit={sendEmail}>
                    ...
                    <input name='email' className='contact__form-input' type="email" placeholder='Your Email Here' required />
                    <textarea className='contact__form-input' name="message" rows="10" placeholder='Your Message' required></textarea>
